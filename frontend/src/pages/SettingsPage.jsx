...
const PREVIEW_MESSAGES = [
  ...
  { id: 2, content: "I'm doing great! Just doing a some new feaures", isSent: true }
]
    ...
    <div className='h-screen container mx-auto px-4 pt-20 max-w-5xl'>
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className='text-sm text-base-content/70'>Chose a theme for your chat interface</p>
        </div>
